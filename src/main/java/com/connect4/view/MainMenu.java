...
public class MainMenu extends JFrame {
    ...
    private JPanel createPlayerSetupScreen() {
        ...
        JComboBox<String> p1Color = new JComboBox<>(
                new String[] { "Red", "Yellow", "Blue", "Green", "Orange", "Purple" });
        ...
        JComboBox<String> p2Color = new JComboBox<>(
                new String[] { "Yellow", "Red", "Blue", "Green", "Orange", "Purple" });
        ...
        startBtn.addActionListener(e -> {
            ...
            if (color1 == color2) {
                JOptionPane.showMessageDialog(this, "Players must choose different colors!", "Error",
    ...
    private JPanel createVsComputerSetupScreen() {
        ...
        JComboBox<String> playerColor = new JComboBox<>(
                new String[] { "Red", "Yellow", "Blue", "Green", "Orange", "Purple" });
