...
public class GUIView implements GameView {
    ...
    private void triggerAIMove() {
        if (aiPlayer == null || state.getGameOver() || windowClosed) return;
        if (!state.getCurrentPlayer().isComputer()) return;
    ...
    private void showConfigDialog() {
        ...
        JComboBox<String> p1Color = new JComboBox<>(new String[]{"Red", "Yellow", "Blue", "Green"});
        gbc.gridx = 1;
        ...
        JComboBox<String> p2Color = new JComboBox<>(new String[]{"Yellow", "Red", "Blue", "Green"});
        gbc.gridx = 1;
        ...
        modeCombo.addActionListener(e -> {
            ...
            if (vsComputer) p2Name.setText("Computer");
            else p2Name.setText("Player 2");
        });
    ...
    private void makeAIMove() {
        if (aiPlayer == null || state.getGameOver()) return;
    ...
    @Override
    public void displayBoard() { update(); }
    
    @Override
    public void displayMessage(String message) { update(); }
    
    @Override
    public void displayError(String error) { update(); }
    
    @Override
    public int getPlayerInput() { return 0; }
