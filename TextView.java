...
public class TextView implements GameView {
    ...
    private void printWelcome() {
        ...
        System.out.println(BOLD + BLUE + "║" + RESET + "         " + BOLD + "CONNECT FOUR - TEXT MODE" + RESET + "        " + BLUE + "║" + RESET);
        System.out.println(BOLD + BLUE + "╚═══════════════════════════════════════════╝" + RESET);
        System.out.println();
    }
    ...
    public int getPlayerInput() {
        ...
        while (true) {
            ...
            if (input.equals("Q") || input.equals("QUIT")) return -2;
            if (input.equals("R") || input.equals("RESTART")) return -1;
            if (input.equals("U") || input.equals("UNDO")) return 0;
            if (input.equals("S") || input.equals("SAVE")) return -3;
            if (input.equals("L") || input.equals("LOAD")) return -4;
            if (input.equals("T") || input.equals("STATS")) return -5;
            if (input.equals("A") || input.equals("ACCEPT")) return -6;
            if (input.equals("X") || input.equals("REJECT")) return -7;
            if (input.equals("G") || input.equals("GUI")) return -8;
            if (input.equals("M") || input.equals("MENU")) return -9;
        ...
        while (running) {
            ...
            switch (input) {
                ...
                case -6:
                    ...
                    break;
                case -9: handleBackToMenu(); break;
                case -8: handleSwitchToGUI(); break;
                case -5: handleStats(); break;
                case -4: handleLoad(); break;
                ...
                case -1:
                    ...
                    break;
                case 0:
                    if (state.undo()) displayMessage("Move undone.");
                    break;
                default:
