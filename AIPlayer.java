...
public class AIPlayer {
    ...
    // =========================================================================
    // NEW: Constants for evaluation scores
    // =========================================================================
    ...
    private int playerNumber;  // Which player the AI is (1 or 2)
    ...
    // =========================================================================
    // NEW: Get the best move for the current position
    // =========================================================================
    /**
    ...
    public int getBestMove(GameState gameState) {
        ...
        for (int column : validMoves) {
            ...
            // After AI moves, it's opponent's turn (minimizing)
    ...
    // =========================================================================
    // NEW: Min/Max algorithm with alpha-beta pruning
    // =========================================================================
    /**
    ...
    // =========================================================================
    // NEW: Position evaluation heuristic
    // =========================================================================
    /**
    ...
    private int evaluatePosition(GameState state) {
        ...
        // Pieces in center columns are more valuable as they participate
    ...
    private int evaluateWindow(Cell[][] cells, int startCol, int startRow, 
        ...
        if (ownCount > 0 && oppCount > 0) {
            return 0;  // Mixed window, can't win here
        }
        
        if (ownCount == 4) return WIN_SCORE / 10;
        if (oppCount == 4) return LOSE_SCORE / 10;
        
        if (ownCount == 3 && emptyCount == 1) return 100;
        if (oppCount == 3 && emptyCount == 1) return -100;
        
        if (ownCount == 2 && emptyCount == 2) return 10;
    ...
    // =========================================================================
    // NEW: Evaluate immediate threats
    // =========================================================================
    /**
    ...
    private int evaluateThreats(GameState state) {
        ...
        for (int col = 1; col <= state.getColumns(); col++) {
            if (!state.isValidMove(col)) continue;
    ...
    // =========================================================================
    // NEW: Check if piece belongs to AI
    // =========================================================================
    /**
    ...
    private boolean isOwnPiece(Cell cell, GameState state) {
        Player aiPlayer = playerNumber == 1 ? 
            state.getSettings().getPlayer1() : state.getSettings().getPlayer2();
        
        Player.CoinColor aiColor = aiPlayer.getCoinColor();
        
        if (cell.isRed() && aiColor == Player.CoinColor.RED) return true;
        if (cell.isYellow() && aiColor == Player.CoinColor.YELLOW) return true;
        if (cell.isLucky()) {
            // Lucky coins count for whoever placed them
            // Approximate by checking turn parity
            return true;  // Simplified - count lucky as own
        }
    ...
    private ArrayList<Integer> getValidMoves(GameState state) {
        ...
        // Prioritize center columns for move ordering
        int center = cols / 2 + 1;
        if (state.isValidMove(center)) moves.add(center);
    ...
    // =========================================================================
    // NEW: Clone game state for simulation
    // =========================================================================
    /**
    ...
    // =========================================================================
    // NEW: Evaluate whether to accept a lucky coin offer
    // =========================================================================
    /**
