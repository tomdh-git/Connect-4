...
public enum DifficultyLevel implements Serializable {
    ...
    public static DifficultyLevel fromLevel(int level) {
        switch (level) {
            ...
            case 4: return BEGINNER_SQUARE;
            case 5: return INTERMEDIATE_SQUARE;
            case 6: return EXPERT_SQUARE;
    ...
    public static DifficultyLevel fromSquareLevel(int level) {
        switch (level) {
            case 1: return BEGINNER_SQUARE;
            case 2: return INTERMEDIATE_SQUARE;
            case 3: return EXPERT_SQUARE;
            default: return BEGINNER_SQUARE;
        }
    }
}
